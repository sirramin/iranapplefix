              ...
              <div className="column large-12 medium-12 small-12">
                <div className="as-banner-cont">
                  <div className="as-banner-image as-banner-image--top">
                    ...
                    <img sizes="(min-width:735px ) 735w, 100vw"
                      src="/content/dam/edam/applecare/images/en_US/psp/psp-banner-hero-repair.image.large_2x.jpg" alt=""
                      srcSet="/content/dam/edam/applecare/images/en_US/psp/psp-banner-hero-repair.image.small_2x.jpg 735w, /content/dam/edam/applecare/images/en_US/psp/psp-banner-hero-repair.image.large_2x.jpg 1440w"
                      className="as-image-speculativedownload" /></div>
                </div>
            ...
            <div className="u-layout u-layout--3up">
              <div className="u-layout-item">
                <div className="contentLink-item">
                  <img src="/content/dam/edam/applecare/images/en_US/psp/content-link-send-your-product_2x.png"
              ...
              <div className="u-layout-item">
                <div className="contentLink-item">
                  <img src="/content/dam/edam/applecare/images/en_US/psp/content-link-genius-store_2x.png" alt="" width="150" className="contentLink-image" height="150" /><div className="contentLink-block">
